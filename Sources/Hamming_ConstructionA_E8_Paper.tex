...
\]
where $e_0$ denotes the real unit, together with the Coxeter parity condition
on the half-integral family~\cite{Coxeter1946,Baez2002}.  Thus the independent
root-list comparison also identifies the code-built short shell with the
classical integral-octonion presentation of the E8 roots.  The octavian
multiplication layer uses the same coordinate convention to define the
