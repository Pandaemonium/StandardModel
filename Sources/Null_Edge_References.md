...
| `TBD-AspectsEverpresentLambdaII` | `arXiv:2307.13743` | Das-Nasiri-Yazdi (Imperial), "Aspects of Everpresent Lambda (II): Cosmological Tests of Current Models" | The OBSERVATIONAL companion: confronts the everpresent-Lambda (stochastic fluctuating dark energy from causal sets + unimodular gravity) with cosmological data - grounds the s10a fork's observational posture (fluctuating vs rigid w=-1). | VERIFIED 2026-07-09 (graph chunk 0/1, authors + stochastic-dark-energy cosmological-tests abstract) |
