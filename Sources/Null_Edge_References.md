...
| `TBD-BombelliHensonSorkin` | `arXiv:gr-qc/0605006` (MPLA 24 (2009) 2579) | Bombelli-Henson-Sorkin, "Discreteness without symmetry breaking: A Theorem" | THE real "hyperuniform => not Lorentz-invariant": Poisson sprinkling is the UNIQUE Lorentz-invariant discrete point process on Minkowski. s10a cites this as the [import] Lorentz core (the finite LambdaFrameConstraint proves only the WEAKER exchangeability/de-Finetti fact). | VERIFIED 2026-07-09 (graph: exact title + Bombelli/Henson/Sorkin authors, gr-qc/0605006) |
| `TBD-QGPhenomLorentz` | `arXiv:gr-qc/0311055` | Henson, "Quantum Gravity Phenomenology, Lorentz Invariance and Discreteness" | Corroborates BHS: any non-random discretization has "nice big regions with no elements" in a boosted frame, so it breaks Lorentz invariance by preferring a frame - the intuition behind Poisson=unique-Lorentz-invariant (s10a fork). | VERIFIED 2026-07-09 (graph chunk) |
| `TBD-Weinberg1989` | RMP 61 (1989) 1 | Weinberg, "The cosmological constant problem" | The ~120-orders discrepancy IS matter-loop feedback into Lambda; s10a now cites it as the [import] reason the order-0 invariance ASSUMES the feedback away (does not protect Lambda). | NEEDS-VERIFY (red-team citation) |
| `TBD-KaloperPadilla` | PRL 112 (2014) 091304 | Kaloper-Padilla, "Sequestering the Standard Model Vacuum Energy" | Unimodular/sequestering [import] for the three-Lambda split (bare + uniform-induced dropped as a decoupled constant); also Henneaux-Teitelboim PLB 222 (1989) 195. | NEEDS-VERIFY (red-team citation) |
| `TBD-ChamseddineConnes-orig` | PRL 77 (1996) 4868; CMP 186 (1997) 731 | Chamseddine-Connes, "The spectral action principle" | The ORIGINAL heat-kernel/Seeley-deWitt theorem making `a2 ~ integral R` - the [import] CONTENT the finite s7 avatar labels but does NOT reproduce (no manifold/short-time limit in finite dim). | NEEDS-VERIFY (red-team citation) |
