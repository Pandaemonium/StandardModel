...
| `TBD-BombelliHensonSorkin` | MPLA 24 (2009) 2579 (`arXiv:0605006`) | Bombelli-Henson-Sorkin, "Discreteness without symmetry breaking" | THE real "hyperuniform => not Lorentz-invariant": Poisson sprinkling is the UNIQUE Lorentz-invariant discrete point process on Minkowski. s10a now cites this as the [import] Lorentz core (the finite LambdaFrameConstraint proves only the WEAKER exchangeability/de-Finetti fact). | NEEDS-VERIFY (red-team citation) |
