#!/usr/bin/env python3
"""
validate_lgt_core.py -- Track C oracle v0.18 (YM ladder, 2026-07-05)
...
print(f"oracle v0.18 | python {platform.python_version()} | numpy {np.__version__}")
print("=" * 78)
...
print("\n[13] Z2 1+1D finite Wilson slab transfer oracle (dynamics v0.18)")
...
check("descriptor JSON record is serializable and summary-consistent",
      descriptor_record["oracle"]["version"] == "v0.18"
