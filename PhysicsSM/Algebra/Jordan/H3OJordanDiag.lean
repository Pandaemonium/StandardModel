...
/-!
# H3O Jordan identity: diagonal components
...
-- Jordan identity for h₃(𝕆): diagonal alpha component
theorem jordanIdentity_alpha (a b : H3O) :
    ((a ○ b) ○ (a ○ a)).alpha = (a ○ (b ○ (a ○ a))).alpha := by
  ...
  simp only [jordanProduct, octonionInner, conj,
...
set_option maxHeartbeats 1600000 in
-- Jordan identity for h₃(𝕆): diagonal beta component
theorem jordanIdentity_beta (a b : H3O) :
    ((a ○ b) ○ (a ○ a)).beta = (a ○ (b ○ (a ○ a))).beta := by
  obtain ⟨aα, aβ, aγ, ⟨ax0, ax1, ax2, ax3, ax4, ax5, ax6, ax7⟩,
                        ⟨ay0, ay1, ay2, ay3, ay4, ay5, ay6, ay7⟩,
                        ⟨az0, az1, az2, az3, az4, az5, az6, az7⟩⟩ := a
  obtain ⟨bα, bβ, bγ, ⟨bx0, bx1, bx2, bx3, bx4, bx5, bx6, bx7⟩,
...
set_option maxHeartbeats 1600000 in
-- Jordan identity for h₃(𝕆): diagonal gamma component
theorem jordanIdentity_gamma (a b : H3O) :
    ((a ○ b) ○ (a ○ a)).gamma = (a ○ (b ○ (a ○ a))).gamma := by
  obtain ⟨aα, aβ, aγ, ⟨ax0, ax1, ax2, ax3, ax4, ax5, ax6, ax7⟩,
                        ⟨ay0, ay1, ay2, ay3, ay4, ay5, ay6, ay7⟩,
                        ⟨az0, az1, az2, az3, az4, az5, az6, az7⟩⟩ := a
  obtain ⟨bα, bβ, bγ, ⟨bx0, bx1, bx2, bx3, bx4, bx5, bx6, bx7⟩,
