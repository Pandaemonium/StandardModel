...
This draft module states a generic finite locality theorem for the P9
...
Scientific role: this is the clean T3 spine. Geometry-blind relation noise
outside the measured diamond cannot affect the frozen local observer readout
when the diamond membership and internal relation data are unchanged.
-/
...
namespace PhysicsSM.Draft.NullEdgeP9DiamondLocalityNoiseInvariance
...
theorem localIntervalCard_eq_of_diamond_local_agreement
  ...
  convert congr_arg Finset.card _
  grind
...
theorem localIntervalSignature_eq_of_diamond_local_agreement
  ...
  exact funext fun k => localIntervalAbundance_eq_of_diamond_local_agreement R S x y k hD hRel

end PhysicsSM.Draft.NullEdgeP9DiamondLocalityNoiseInvariance
