...
`cecaf26c-ab7d-4484-b901-01e12c077659`.
...
namespace PhysicsSM.Draft.NullEdgeP1SU2NormalizedDetInvariance
...
the left unitary identity explicitly so the theorem is a small finite matrix
statement rather than an API hunt.
-/
...
/-- Determinant is invariant under a determinant-one residual spin-frame congruence. -/
...
end PhysicsSM.Draft.NullEdgeP1SU2NormalizedDetInvariance
