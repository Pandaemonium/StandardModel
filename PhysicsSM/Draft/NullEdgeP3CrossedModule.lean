...
This module formalizes crossed-module transport and vertical/horizontal composition.
It integrates Aristotle project `1f2a340d-e077-4dfe-a682-c018f5e99fea`.

It defines:
* A `CrossedModule` structure representing H -> G.
* A `FakeFlat` predicate on path pairs.
* Vertical/horizontal compositions of 2-cells.
* Proofs that composition preserves fake-flatness and satisfies the 2-cell interchange law.
-/
...
theorem fakeFlat_horizontalCompose (X : CrossedModule G H) (P Q : PathPair G) (hP hQ : H)
  ...
  convert congr_arg₂ ( · * · ) hfP hfQ using 1;
...
theorem crossedModule_2cell_interchange (X : CrossedModule G H)
  ...
  -- Key fact: hC * X.act D.left⁻¹ hB = X.act C.left⁻¹ hB * hC
