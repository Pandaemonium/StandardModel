...
This module isolates the finite differential-topology rung needed by the
anomalous-Floquet route. A linearized two-band crossing has three Pauli
...
The normalization witness and transformation laws prevent a basis convention
from silently changing the charge. This is a project-original finite
formalization of the standard local Weyl-charge calculation. It does not prove
that a crossing exists in the live Null-Edge walk or that a single Weyl sector
is globally realizable.
-/

noncomputable section

namespace PhysicsSM.Draft.NullEdge.FloquetWeylOrientationCharge
...
def Nondegenerate (A : Jac) : Prop := Ne A.det 0
...
/-- A positive charge is a genuinely isolated linear crossing. -/
...
/-- info: 'PhysicsSM.Draft.NullEdge.FloquetWeylOrientationCharge.positive_smul' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms positive_smul

end PhysicsSM.Draft.NullEdge.FloquetWeylOrientationCharge
