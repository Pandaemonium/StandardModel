...
/-!
# Covariant finite-fiber link/face Palatini variation

This module lifts the scalar additive link/face Palatini control to an
arbitrary finite real fiber. A matrix on each directed link transports fiber
components forward. Exact periodic summation by parts then places the
algebraic transpose of the predecessor transport in the backward adjoint.

The main chain proves:

* transpose transport is adjoint for the finite Euclidean component pairing;
* the covariant plaquette-curl response pairs with a local transported Euler
  coefficient;
* arbitrary site/direction/component probes identify connection stationarity
  with pointwise vanishing of that coefficient;
* for an antisymmetric face field, the equation is exactly vanishing
  covariant backward face divergence;
* identity transport and site-constant face data provide a nonvacuous
  stationary control.

## Scope and provenance

These are finite linear-algebra identities and a transported consistency
check, not yet a nonlinear Lorentz-group Palatini action or an Einstein
equation. The component pairing in this module is Euclidean, so the backward
operator uses ordinary transpose. A Lorentzian bivector specialization must
replace it with the convention-appropriate Krein adjoint, derive the face
field from null-coframe `e wedge e` data and dual volumes, and prove compatible
Levi-Civita link selection.

The architecture extends
`FinitePeriodicLinkPalatiniVariation` componentwise and uses the standard
finite-matrix adjoint and periodic reindexing identities. Claim labels: finite
identity and transported linearized consistency check. Originality tag:
`[orig]`, with standard matrix/lattice identities treated as `[import]`.
-/

namespace PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation
...
/-- info: 'PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation.sum_pair_covariantForwardDifference_periodic' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms sum_pair_covariantForwardDifference_periodic

/-- info: 'PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation.covariantLinkFaceFirstVariation_eq_eulerPairing' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms covariantLinkFaceFirstVariation_eq_eulerPairing

/-- info: 'PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation.covariantLinkConnectionEulerLagrange_iff_divergence' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms covariantLinkConnectionEulerLagrange_iff_divergence

/-- info: 'PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation.identity_siteConstant_covariantLinkConnectionEulerLagrange' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms identity_siteConstant_covariantLinkConnectionEulerLagrange

end PhysicsSM.Draft.NullEdge.FinitePeriodicCovariantLinkPalatiniVariation
