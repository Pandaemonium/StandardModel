/-
Provenance: Aristotle job 497535a1 (fable-pub-phasedefect-20260711),
harvested 2026-07-11 ~08:20 PDT; memo at
`AgentTasks/aristotle-results/phasedefect-497535a1/.../MEMO.md`.
Statements integrated UNCHANGED except this header. Source: external
expert (Pro) memo section 2 (`PRO_ANALYSIS_H1-H7_2026-07-11.md`), whose
core identity and the NECESSITY of the equal-modulus hypothesis were
verified in sympy before submission; the prover additionally confirmed
the identity over Z[i] before proving. Kernel-only: standard three
axioms, no native_decide (guard-pinned in OvernightTheoryAxiomGuard).
Physics scope: one-particle free-carrier phase observable - equal-modulus
fields with different transported relative phase have different spectra;
preregistered gap observable gSq; exact zero-mode locus. NOT a
topological-protection statement.
-/
import Mathlib
