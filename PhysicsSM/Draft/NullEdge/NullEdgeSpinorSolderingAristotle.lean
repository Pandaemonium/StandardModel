...
77a20238-4b8d-4f83-8f4a-5d28f8bafe61; all 11 statements verbatim from the
submitted package (verified 23/23 declarations), fully proven (0 placeholders),
kernel EXIT 0, namespace renamed for the draft tree, standard-three axiom
guards added at integration. Companion bridge lemmas to the landed
`Spinor.PluckerMassCovariance` and `Draft.NullEdge.SL2CLorentzAction` and the
spiral `SpinCornerBargmann` are tracked as a follow-up module.
...
namespace PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering
...
end PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering


/-! ## Build-enforced assumption-footprint guards (added at integration) -/

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.vecOfHerm_hermOfVec' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.vecOfHerm_hermOfVec

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.hermOfVec_det_eq_minkowskiSq' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.hermOfVec_det_eq_minkowskiSq

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_minkowskiSq' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_minkowskiSq

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_time' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_time

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_time_nonneg' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_time_nonneg

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_smul' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.nullEdgeVector_smul

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.rankOne_mulVec' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.rankOne_mulVec

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_minkowskiSq_eq_wedge' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_minkowskiSq_eq_wedge

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_timelike_iff_wedge_ne_zero' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_timelike_iff_wedge_ne_zero

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_minkowskiSq_sl2_invariant' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.twoEdge_minkowskiSq_sl2_invariant

/-- info: 'PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.rest_frame_witness' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.NullEdgeSpinorSoldering.rest_frame_witness
