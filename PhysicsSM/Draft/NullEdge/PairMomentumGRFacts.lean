/-
Provenance: part of Aristotle job b94c21da (fable-24h-momentum); see
PairMomentumBlocks.lean header. File renamed from GRFacts.lean; imports
rewired; content otherwise unchanged.
-/
