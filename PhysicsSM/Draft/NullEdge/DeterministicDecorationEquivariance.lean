...
`aa1888ab-da73-4c45-9c82-bafcee4907ed` and replayed locally under the pinned
...
/-- info: 'PhysicsSM.Draft.NullEdge.DeterministicDecorationEquivariance.decorationGraph_invariant_iff_equivariant' depends on axioms: [propext, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms decorationGraph_invariant_iff_equivariant

/-- info: 'PhysicsSM.Draft.NullEdge.DeterministicDecorationEquivariance.decoratedLaw_invariant_of_equivariant' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms decoratedLaw_invariant_of_equivariant
...
#guard_msgs (whitespace := lax) in
#print axioms decoratedLaw_invariant_iff_equivariant

/-- info: 'PhysicsSM.Draft.NullEdge.DeterministicDecorationEquivariance.decoratedLaw_const_invariant' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms decoratedLaw_const_invariant
