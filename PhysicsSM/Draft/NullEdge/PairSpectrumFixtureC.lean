/-
Provenance: companion file of Aristotle job 4d9642bf (fable-24h-
boundstate); see PairSpectrumFixture.lean header. Import rewired from
context.PairSpectrumFixture. Carries the physical-matrix transports
(V_eq_U2_K2, V_annihilated; native-transported, disclosed).
-/
