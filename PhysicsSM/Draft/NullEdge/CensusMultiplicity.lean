/-
Provenance: Aristotle jobs 2cc1968c (original landing) + 48a540a1
(kernel-decide retrofit, harvested 2026-07-12 ~00:55 PDT). The four
public theorem statements are BYTE-IDENTICAL to the original landing;
all 40 native_decide invocations were replaced by simp/norm_num
elaboration (kernel decide cannot reduce Rat gcd normalization or the
Leibniz determinant; the prover built walk_reduce/det_reduce tactics
instead). FOOTPRINT NOW KERNEL-ONLY: [propext, Classical.choice,
Quot.sound] on all four public theorems - Paper C's multiplicity
census no longer carries compiled-evaluator trust.
Oracle: census_oracle.py (2026-07-11), certificates in the docstring.
-/
/-
