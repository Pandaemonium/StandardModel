...
Integrated 2026-07-16 from Aristotle project 958c6429-bbbc-4bc6-b289-954222616673 (run wave6); statements verbatim from the submitted package; namespace renamed for the draft tree; axiom guards added at integration.
...
namespace PhysicsSM.Draft.NullEdge.BargmannJarlskogToy
...
theorem jarlskog_decomposition (a1 a2 a3 b1 b2 b3 : Vec3) :
    jarlskogObs a1 a2 a3 b1 b2 b3
      = (triple a1 a2 a3 * (1 + dot b1 b2 + dot b2 b3 + dot b3 b1)
        ...
        / 16 := by
  unfold jarlskogObs triple dot;
  simp [famTrace, proj, pauli, sigmaX, sigmaY, sigmaZ];
...
theorem jarlskog_antisymm (a1 a2 a3 b1 b2 b3 : Vec3) :
  ...
  rw [jarlskog_decomposition a1 a2 a3 b1 b2 b3,
    jarlskog_decomposition b1 b2 b3 a1 a2 a3]
  ring
...
theorem jarlskog_cp_odd (a1 a2 a3 b1 b2 b3 : Vec3) :
  ...
  rw [jarlskog_decomposition, jarlskog_decomposition]
  unfold triple dot
  ring
...
theorem jarlskog_rotation_invariant (R : Matrix (Fin 3) (Fin 3) ℝ)
  ...
  rw [jarlskog_decomposition, jarlskog_decomposition]
  have h_dot : ∀ (u v : Vec3), dot (R.mulVec u) (R.mulVec v) = dot u v := by
    intro u v
    simp +decide [dot, Matrix.mulVec]
    simp_all +decide [← Matrix.ext_iff, Fin.forall_fin_succ, dotProduct]
    simp_all +decide [Matrix.mul_apply, Fin.sum_univ_three]
    grind
  have h_triple : ∀ (u v w : Vec3),
      triple (R.mulVec u) (R.mulVec v) (R.mulVec w) = triple u v w := by
    intro u v w
    unfold triple
    simp +decide [Matrix.mulVec, dotProduct]
    ring_nf
    simp_all +decide [Fin.sum_univ_three, Matrix.det_fin_three]
    grind
  rw [h_triple, h_triple, h_dot, h_dot, h_dot, h_dot, h_dot, h_dot]
...
theorem jarlskog_equal_families (a1 a2 a3 : Vec3) :
  ...
  unfold jarlskogObs
  norm_num [Complex.mul_conj, Complex.normSq]
...
theorem jarlskog_witness :
  ...
  convert jarlskog_decomposition _ _ _ _ _ _ using 1 <;>
    norm_num [ex, ey, ez, exy, triple, dot]
  repeat erw [Matrix.cons_val_succ']
  norm_num

end PhysicsSM.Draft.NullEdge.BargmannJarlskogToy

/-! ## Build-enforced assumption-footprint guards (added at integration) -/

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_decomposition' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_decomposition

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_antisymm' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_antisymm

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_cp_odd' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_cp_odd

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_rotation_invariant' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_rotation_invariant

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_both_planar' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_both_planar

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_equal_families' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_equal_families

/-- info: 'PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_witness' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.BargmannJarlskogToy.jarlskog_witness
