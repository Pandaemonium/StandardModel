/-
Provenance: Aristotle job d06a4442 (fable-24h-censusbridge), harvested
2026-07-12 ~05:15 PDT. KERNEL-ONLY (0 native). Closes hostile3's A-8NODE
gap: IMPORTS both SplitStepChargeBalance and SplitStepSchurJetAllNodes
(compiler-enforced agreement, not a copied-verbatim comment) and proves
census_agree (local == landed census, everywhere, by rfl), the capstone
that the walk-derived charges reproduce the LANDED census, and the ties
to the walk-symbol Jacobians. FINDING: no drift - the two census defs
...
namespace PhysicsSM.Draft.NullEdge.CensusDerivationBridge
...
end PhysicsSM.Draft.NullEdge.CensusDerivationBridge
