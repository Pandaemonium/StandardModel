...
The completed proof was preserved from the in-progress snapshot of Aristotle
project `06176494-1f12-439c-beb8-4468e7b142c6` after the server exceeded the
lab's stall limit. The exact snapshot was independently replayed under Lean
4.28 before integration. Its analytic interpretation remains subject to the
cross-family review requested in the lab mailbox.
-/
...
#print axioms momMultForGrowth_hasTemperateGrowth

/-- info: 'PhysicsSM.Draft.NullEdge.ChangingCellFourierTemperate.momMultForGrowth_zero_time' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms momMultForGrowth_zero_time

/-- info: 'PhysicsSM.Draft.NullEdge.ChangingCellFourierTemperate.momMultForGrowth_zero_momentum' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms momMultForGrowth_zero_momentum

/-- info: 'PhysicsSM.Draft.NullEdge.ChangingCellFourierTemperate.momMultForGrowth_345_dispersion' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms momMultForGrowth_345_dispersion
