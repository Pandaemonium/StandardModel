/-
Provenance: Aristotle job 9b4d417a (fable-24h-selection2), harvested
2026-07-11 ~22:50 PDT. The four audit-repair theorems (hostile2
F5/F7/F9/F10) landed KERNEL-ONLY, definitions copied verbatim from the
landed modules: scalar_gauge_collapse (Hermiticity hypothesis unused,
noted in docstring - the collapse is even stronger than claimed),
equivariance_violating_control, no_odd_generator_on_full_samesite_block
(extends the {0,13} corner to {0,13,22,27}), G2_census_exact (exactly
four -1-fixed states + the explicit component-flip partner involution).
Closes all four kernel-repairable findings of HOSTILE_REVIEW_2.
-/
import Mathlib
