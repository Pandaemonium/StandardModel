/-
Provenance: Aristotle job 6b89c65a (fable-24h-fbgroupiso), harvested
2026-07-12 ~05:36 PDT. KERNEL-ONLY (sorry-free; the one 'sorry' token is
in the instantiation note comment). Closes red-team F2: upgrades the FB
SU(3) correspondence from MulEquiv-onto-submonoid to a GROUP isomorphism
with explicit map_inv/map_div, proved generically over a group G and a
submonoid S = specialUnitaryGroup - exactly the project's situation;
the concrete one-line instantiation is noted in-file.
-/
import Mathlib
