...
/-- Complex scalar action on the Dixon algebra (component-wise on the four colour
coefficients; `ComplexOctonion` already carries `SMul C`). -/
instance : SMul ℂ Dixon := ⟨fun z d => ⟨z • d.x0, z • d.x1, z • d.x2, z • d.x3⟩⟩
