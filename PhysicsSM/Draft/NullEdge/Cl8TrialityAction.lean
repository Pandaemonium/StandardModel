...
theorem rho3c_c1 : rho3c c1 = -c5 := by
  ext <;> simp [rho3c, rho3o, c1, c5]

theorem rho3c_c2 : rho3c c2 = c3 := by
  ext <;> simp [rho3c, rho3o, c2, c3]

theorem rho3c_c3 : rho3c c3 = c4 := by
  ext <;> simp [rho3c, rho3o, c3, c4]

theorem rho3c_c4 : rho3c c4 = c2 := by
  ext <;> simp [rho3c, rho3o, c4, c2]

theorem rho3c_c5 : rho3c c5 = c6 := by
  ext <;> simp [rho3c, rho3o, c5, c6]

theorem rho3c_c6 : rho3c c6 = -c1 := by
  ext <;> simp [rho3c, rho3o, c6, c1]
...
theorem rho3_conj_C1 (z : ComplexOctonion) :
  ...
  rw [C1, rho3c_mul, rho3c_c1]
  ext <;> simp [C5, ComplexOctonion.mul_re, ComplexOctonion.mul_im] <;> ring

theorem rho3_conj_C2 (z : ComplexOctonion) :
    rho3c (C2 z) = C3 (rho3c z) := by
  rw [C2, rho3c_mul, rho3c_c2]
  rfl
...
theorem rho3_conj_colourGen (a : Fin 6) (z : ComplexOctonion) :
  ...
  fin_cases a <;>
    simp [colourGen, trialityPerm, trialitySign, C1, C2, C3, C4, C5, C6,
      rho3c_mul, rho3c_c1, rho3c_c2, rho3c_c3, rho3c_c4, rho3c_c5,
      rho3c_c6] <;>
