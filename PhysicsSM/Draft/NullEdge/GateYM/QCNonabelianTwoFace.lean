...
theorem twoface_curvatureGram_eq_holonomyGram {n : Type*} [Fintype n]
  ...
  simp +decide [ sub_mul, mul_sub, ← Matrix.mul_assoc, h₁, h₂ ];
  simp_all +decide [ Matrix.mul_assoc, mul_eq_one_comm.mp h₁, mul_eq_one_comm.mp h₂ ]
...
theorem twoface_curvatureGram_posSemidef {n : Type*} [Fintype n]
    (W₁ W₂ : Matrix n n ℂ) :
...
theorem hz_kreinGram_not_posSemidef :
  ...
  rintro ⟨ ⟩;
  rename_i h₁ h₂; have := h₂ ( Finsupp.single 1 1 ) ; norm_num [ Hz, Jform, Fin.sum_univ_succ ] at this;
  norm_num [ Complex.ext_iff, Matrix.mul_apply ] at this;
  norm_num [ Complex.ext_iff, Complex.le_def ] at this
...
theorem hz_kreinGram_not_negSemidef :
  ...
  intro h;
  have := h.2;
  specialize this ( Finsupp.single 0 1 ) ; norm_num [ Fin.sum_univ_succ ] at this;
  norm_num [ Complex.le_def, Complex.ext_iff, Matrix.mul_apply ] at this;
  norm_num [ Hz, Jform ] at this
