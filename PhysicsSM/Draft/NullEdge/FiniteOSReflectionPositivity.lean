...
/-!
# Finite Osterwalder--Schrader reflection positivity

This module separates a genuine finite reflected-time positivity condition from
ordinary positive-definiteness of the full measure matrix. It identifies the
reflected pairing with the transported negative-positive block, constructs the
null-space quotient inner-product space under reflection compatibility, and
provides explicit two-point counterexamples showing that neither positivity
notion implies the other.

This is a finite real-matrix model of the Osterwalder--Schrader algebraic step.
It is not reflection positivity of an interacting lattice gauge field algebra,
does not derive a transfer Hamiltonian, and does not prove an infinite-volume
or continuum reconstruction theorem.

Provenance: Aristotle project `c2b7bd0d-ef38-411a-8431-b772af83f5cb`, task
`82d54463-9b58-4566-9dbe-646ef58fe0e2`, integrated and semantically scoped
2026-07-21.
-/
