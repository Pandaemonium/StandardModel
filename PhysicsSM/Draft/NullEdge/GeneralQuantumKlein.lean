...
namespace PhysicsSM.Draft.NullEdge.GeneralQuantumKlein
...
end PhysicsSM.Draft.NullEdge.GeneralQuantumKlein

-- Axiom-footprint guards (draft-trust by kernel): kernel axioms only, no
-- `native_decide` / `Lean.ofReduceBool`.
/--
info: 'PhysicsSM.Draft.NullEdge.GeneralQuantumKlein.qKlein_nonneg' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.GeneralQuantumKlein.qKlein_nonneg

/--
info: 'PhysicsSM.Draft.NullEdge.GeneralQuantumKlein.entropy_trace_eq_sum' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs (whitespace := lax) in
#print axioms PhysicsSM.Draft.NullEdge.GeneralQuantumKlein.entropy_trace_eq_sum
