...
`e2cc5463-a4f5-4f23-9a4a-a16592cffc22` and replayed locally under the pinned
...
/-- info: 'PhysicsSM.Draft.NullEdge.EqualMagnitudePhaseInterferometer.equal_local_magnitudes' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms equal_local_magnitudes

/-- info: 'PhysicsSM.Draft.NullEdge.EqualMagnitudePhaseInterferometer.squareInterferenceScore_gauge_invariant' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms squareInterferenceScore_gauge_invariant
...
#guard_msgs (whitespace := lax) in
#print axioms equal_magnitude_profiles_are_operationally_distinct
