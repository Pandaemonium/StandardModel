...
theorem sigmac_mul (x y : ComplexOctonion) :
  ...
  ext <;>
    simp [sigmac, sigmao, ComplexOctonion.mul_re,
...
theorem sigma_conj_colourGen (a : Fin 6) (z : ComplexOctonion) :
  ...
  fin_cases a <;>
    simp [colourGen, sigmaPerm, sigmaSign, C1, C2, C3, C4, C5, C6,
      sigmac_mul, sigmac_c1, sigmac_c2, sigmac_c3, sigmac_c4, sigmac_c5,
      sigmac_c6] <;>
