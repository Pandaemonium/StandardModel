...
The proofs were returned by Aristotle project
`ad6685ad-2c7c-4563-9a95-2916b5fde8e6` and replayed locally under the pinned
Lean 4.28 toolchain without changing any theorem statement.
-/
...
/-- info: 'PhysicsSM.Draft.NullEdge.ExactFlowL2GroupCapstone.momMult_add_time' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms momMult_add_time
...
#guard_msgs (whitespace := lax) in
#print axioms momMultL2Isometry_add_time
...
#guard_msgs (whitespace := lax) in
#print axioms positionExactFlowL2Isometry_add_time

/-- info: 'PhysicsSM.Draft.NullEdge.ExactFlowL2GroupCapstone.momMultL2Isometry_mul_neg_time' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms momMultL2Isometry_mul_neg_time
...
#guard_msgs (whitespace := lax) in
#print axioms positionExactFlowL2Isometry_neg_time_mul

/-- info: 'PhysicsSM.Draft.NullEdge.ExactFlowL2GroupCapstone.position_orbit_continuous_control' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms position_orbit_continuous_control
