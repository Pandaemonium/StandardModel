...
/-!
# Helper lemmas for the core counting theorem

This file provides the one-dimensional lift counting lemmas needed
for `residueShellSet_ncard_eq_residueConvolution`.
-/
...
-- Local copies of definitions from the main file.
