...
namespace PhysicsSM.Draft.NullEdgeCausetOrderingFraction
...
theorem two_mul_chainRelationCount (n : Nat) :
  ...
  -- chainRelationCount n = ∑ i ∈ Finset.range n, i
  have h_chainRelationCount : chainRelationCount n = ∑ i ∈ Finset.range n, i := by
  ...
  rw [h_chainRelationCount, mul_comm]
...
theorem antichain_relationCount_zero (n : Nat) :
  ...
  norm_num [ Finset.filter_eq_empty_iff ]

end PhysicsSM.Draft.NullEdgeCausetOrderingFraction
