...
/-!
# Helper lemmas for E8 theta transform proof

These lemmas only depend on Mathlib (no SpherePacking imports).
-/
...
namespace PhysicsSM.Coding.E8ThetaDim8.Helpers
...
lemma thetaProfile_iteratedDeriv (τ : ℂ) (n : ℕ) (r : ℝ) :
  ...
  convert HasDerivAt.const_mul _ ( HasDerivAt.comp r ( Complex.hasDerivAt_exp _ ) ( HasDerivAt.const_mul _ ( hasDerivAt_id' r |> HasDerivAt.ofReal_comp ) ) ) using 1 ; ring!;
...
end PhysicsSM.Coding.E8ThetaDim8.Helpers
