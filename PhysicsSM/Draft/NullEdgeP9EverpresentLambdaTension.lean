...
namespace PhysicsSM.Draft.NullEdgeP9EverpresentLambdaTension
...
theorem uniformSecondMoment_antitone (A : Real) {M N : Nat}
  ...
  exact div_le_div_of_nonneg_left ( sq_nonneg _ ) ( by positivity ) ( mod_cast hMN )
...
theorem uniformSuppression_below_everpresent (A : Real) {N : Nat}
  ...
  rw [uniformSecondMoment, everpresentSecondMoment,
    div_lt_iff₀ (by positivity : (0 : ℝ) < (N : ℝ))]
  nlinarith [hscale]

end PhysicsSM.Draft.NullEdgeP9EverpresentLambdaTension
