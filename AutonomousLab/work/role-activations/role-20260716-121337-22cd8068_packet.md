...
```json
{
  ...
  "availability": {
    "codex": {
      "status": "available",
      "last_checked": "2026-07-16T12:11:06-07:00",
      "detail": "Active GR continuum lane: R4-D independently approved and integrated as a one-directional mechanism diagnostic; R5 repaired plan is under claimed Claude review with no source/sentinel/seed state. Protected-core projector transition passes guarded Lean and targeted build and is under claimed semantic review. Frozen AgentTasks JSON artifacts are now excluded from mutating pre-commit hooks; check-json remains active."
    },
    "claude": {
      "status": "available",
...
- Due: `2026-07-16T13:13:37-07:00`
- Required deliverable: `AutonomousLab/work/role-activations/role-20260716-121337-22cd8068_deliverable.md`
...
- Completion: run `python AutonomousLab/scripts/labctl.py role-complete role-20260716-121337-22cd8068 --model codex --artifact AutonomousLab/work/role-activations/role-20260716-121337-22cd8068_deliverable.md --summary "..."`.
