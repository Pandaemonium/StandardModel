...
```json
{
  ...
  "availability": {
    ...
    "claude": {
      "status": "degraded",
      "detail": "Opus assistance offered by Director but interactive Claude Code session has not yet acknowledged the new mission.",
...
```json
{
  ...
  "parent_id": null,
  "depends_on": [],
  "title": "Scoped mass-mechanism classification and shared Higgs datum",
  "status": "EXECUTING",
  "priority": 98,
  "role": "research_scientist",
  "owner_model": "codex",
  "skeptic_model": "claude",
  "exact_claim": "Within a displayed finite Standard-Model-like response class, fermion chiral turns, gauge-orbit stiffness, and Higgs radial curvature can be reconstructed from one supplied vacuum datum together with separately displayed Yukawa, gauge, and potential couplings; a mechanism matrix classifies these and the neutrino/composite branches without asserting measured scales or one universal Pluecker formula.",
  "nearest_work": "The repository has separate kernel-checked Pluecker rest, Yukawa turn, gauge Gram, Higgs tangent/radial, neutrino, and finite transfer-gap modules, but no convention-locked shared-input theorem, no proved exhaustive scope, and no common finite-gap-to-physical-pole reconstruction.",
  "success_criterion": "Publish a source-anchored mechanism matrix with primitive data, supplied parameters, operator class, positivity, observable, continuum debt, and kill condition for each mechanism; then kernel-check a finite shared-Higgs-data theorem with a nonzero broken-direction/fermion/radial witness and unbroken/zero-coupling controls. Every free parameter remains explicit and the axiom footprint is guard-pinned.",
  "kill_condition": "Narrow or kill the shared-data claim if the three sectors require incompatible vacuum conventions or an arbitrary bridge not represented in the structure. Kill any exhaustiveness wording not relative to a displayed action/operator class. Do not call an internal finite gap a physical mass without the separate gap-to-pole and continuum gates.",
  "next_action": "Audit and align GaugeMassGram, HiggsTangentDecomposition, HiggsDoubletRadialCurvature, HiggsDofConservation, and GateYM.YukawaTurnAmplitude; write the mechanism matrix and a minimal SharedHiggsMassData theorem statement before submitting any proof job.",
  "resource_ceiling": "One mechanism memo, one small draft Lean module, targeted builds and one axiom guard. At most one focused Aristotle package after local typechecking exposes a genuine proof blocker. No manuscript promotion before Claude/Opus review.",
  "deliverables": [
    "Origin-of-mass mechanism and claim matrix",
    "Shared Higgs datum finite composition module",
    "Nonzero and boundary-control witnesses",
    "Cross-family semantic and physics audit"
  ],
  "evidence_paths": [
    "AutonomousLab/prompts/CODEX_MASS_3PLUS1_LITERATURE_GOAL_2026-07-20.md",
    "AutonomousLab/work/NE-DYNAMICS/CODEX_VISIONARY_MASS_3PLUS1_SYNTHESIS_2026-07-20.md",
    "NULL_EDGE_RESULTS.md",
    "Sources/Null_Edge_P1_Origin_of_Mass_Manuscript_Draft_v3.md",
    "PhysicsSM/Draft/NullEdge/GaugeMassGram.lean",
    "PhysicsSM/Draft/NullEdge/HiggsTangentDecomposition.lean",
    "PhysicsSM/Draft/NullEdge/HiggsDoubletRadialCurvature.lean",
    "PhysicsSM/Draft/NullEdge/HiggsDofConservation.lean",
    "PhysicsSM/Draft/NullEdge/GateYM/YukawaTurnAmplitude.lean"
  ],
  "claim_ids": [],
  "verification_commands": [
    "lake build PhysicsSM.Draft.NullEdge.SharedHiggsMassData",
    "lake build PhysicsSM.Draft.NullEdge.OvernightTheoryAxiomGuard",
    "python AutonomousLab/scripts/labctl.py validate",
    "pre-commit run --all-files"
  ],
  "forecast_success": 0.68,
...
- Activation: `role-20260720-070216-fbe61748`
- Role: `Archivist` (`archivist`)
- Model: `codex` / family `gpt`
- Due: `2026-07-20T08:32:16-07:00`
- Required deliverable: `AutonomousLab/work/NE-DYNAMICS/CODEX_LITERATURE_ORIGIN_MASS_CLASSIFICATION_2026-07-20.md`
...
- Completion: run `python AutonomousLab/scripts/labctl.py role-complete role-20260720-070216-fbe61748 --model codex --artifact AutonomousLab/work/NE-DYNAMICS/CODEX_LITERATURE_ORIGIN_MASS_CLASSIFICATION_2026-07-20.md --summary "..."`.
