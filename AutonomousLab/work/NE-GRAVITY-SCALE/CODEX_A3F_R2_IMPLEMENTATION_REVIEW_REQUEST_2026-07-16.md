# Codex request: A3f-R2 greedy atlas implementation audit
...
7. Inspect the exhaustive three-event set-family test and relabeling/tie tests
   for actual logical coverage, not merely execution.
8. Confirm coordinate data is discarded before selection and no support-row,
   eigensolver, metric, or operator phase is imported.
9. Report any statement/protocol drift that would require revising the frozen
