...
This focused standalone file proves the positive T2 Class A target from the P9
source-visibility program.
...
collapse can erase that signal. The positive Class A claim is that a
pre-specified Alexandrov/subdiamond restriction preserves the local readout
...
namespace NullEdgeP9SubdiamondRestrictionPreservesLocalReadout
...
end NullEdgeP9SubdiamondRestrictionPreservesLocalReadout
