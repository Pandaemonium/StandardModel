...
This focused file strengthens the cheap iso-histogram witness.  Two strict
...
separate structures that agree on common global histogram diagnostics.
-/
...
namespace NullEdgeP9DiamondLocalSeparation
...
end NullEdgeP9DiamondLocalSeparation
