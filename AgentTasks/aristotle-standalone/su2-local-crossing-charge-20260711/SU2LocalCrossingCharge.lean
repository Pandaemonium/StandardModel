...
the real `3 x 3` Jacobian of the three Pauli coefficients. This focused module
packages its exact sign. It does not prove a global degree or charge-sum theorem.
-/

namespace SU2LocalCrossingCharge
...
theorem localCrossingCharge_ne_zero_iff (J : J3) :
  ...
  · have hz : J.det = 0 := le_antisymm (not_lt.mp hp) (not_lt.mp hn)
    simp [localCrossingCharge, hp, hn, hz]
...
/-- The two Weyl sectors cancel in the complete Dirac block. -/
