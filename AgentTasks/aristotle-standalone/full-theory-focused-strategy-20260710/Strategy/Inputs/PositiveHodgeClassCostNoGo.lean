...
Scientific consequence: positive spectral mass survives. What fails is the
claim that varying by exact representatives changes the cost while radicality,
nilpotence, and decoder descent all hold. A nontrivial variational theory must
instead vary decoder moduli, positive-sector data, non-exact physical states, or
