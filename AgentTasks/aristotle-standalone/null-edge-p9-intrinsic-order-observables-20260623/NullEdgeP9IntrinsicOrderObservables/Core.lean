...
This focused file formalizes a small part of the new P9 intrinsic-observable
guardrail. Causal-set pilots should prefer observables that depend only on the
order relation, not on a chosen block offset or labeling. Interval abundance and
degree histograms are two such finite observables.
-/
...
namespace NullEdgeP9IntrinsicOrderObservables
...
end NullEdgeP9IntrinsicOrderObservables
