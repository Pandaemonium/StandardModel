...
This focused file isolates a finite-algebra warning from the P9 coarse-map
...
namespace NullEdgeP9OffsetWindowGuardrail
...
end NullEdgeP9OffsetWindowGuardrail
