...
/-!
# Positive/negative branch resolution for the two-level chiral Hamiltonian

This focused target extends the positive-branch projector certification.  It
adds the negative branch, proves the two branches are complementary and
orthogonal on shell, and records the finite spectral reconstruction
`E • (P+ - P-) = H`.
-/

noncomputable section

namespace NullEdgeP2BranchResolution
...
end NullEdgeP2BranchResolution
