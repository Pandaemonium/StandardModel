...
- `wilsonPlaquetteSumC`, `wilsonPlaquetteSum_pos`, `wilsonPlaquetteSumC_ne_zero`, `wilsonLocalWeightC_class`, `wilson_gamma`, `wilson_iterConv_eigen_at_one`, `wilson_iterConv_normalized_at_one`, `wilsonNormalizedGamma`, `wilson_iterConv_normalizedGamma_at_one` in `Theorem2AreaLaw.lean`.
