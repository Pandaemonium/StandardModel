...
| T3 | YM0 breadth: general-G core + D12 | claimed-codex | Codex | `PhysicsSM/Draft/NullEdge/GateYM/GaugeCoreGeneral.lean`, `PhysicsSM/Draft/NullEdge/GateYM/LatticeEnsemble*.lean`, `PhysicsSM/Draft/NullEdge/GateYM.lean`, shared run files | `GaugeCoreGeneral.lean` landed general-G typed-walk/gauge-covariance core + change-of-variables; review thread open |
| T4 | QCD1 Banks-Casher shadow | claimed-claude | Claude | `PhysicsSM/Draft/NullEdge/GateYM/BanksCasher*.lean`, `GateYM.lean` (aggregator wiring only) | Built on GateC2 spectral assets; ranked above KP/Peter-Weyl in the strategy audit's sequencing |
| T5 | YM4 groundwork: KP + polymers | open | - | `PhysicsSM/Draft/NullEdge/GateYM/PolymerKP*.lean` | KP hypotheses BLOCKED on LIT item 3 |
| T6 | YM-LIT verification sprint | open | - | `LIT_LOG.md`, graph/Zotero | Items 1, 3, 8 are load-bearing; new item from strategy audit: Luscher 1977 vs Osterwalder-Schrader misattribution risk |
