...
| T1 Wilson cut factorization | Q1 | claimed-claude | claude | PhysicsSM/Draft/NullEdge/GateYM/WilsonReflectionPositivity*.lean | flagship; starting with ReflectionCutExample geometry |
