...
support-counting strategy. Harvest status should be checked from `aristotle
list` before any integration.
...
sleep-polling active Aristotle jobs. The Q8 bridge prompt explicitly asks
