...
| (seed) | planning | A | Q3: review the drafted flux-sector definitions, then return the general finite-G sector decomposition (label, projections, preservation theorems) in Lean syntax, with the Z2 torus as its instance | ready - packet `AgentTasks/fable-prompts/fable-A-q3-flux-sector-20260704.md`, attach `FluxSectorGeneral.lean` + `FluxSectorZ2.lean` |
