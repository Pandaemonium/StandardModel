...
- Current status: Aristotle project `7c0ed511` completed as a partial
  ...
  proves child membership plus same-component reachability. The remaining
  named blocker is still the geometric block-decomposition/reindex/fiber-count
  part of `pairSum_le_expBound`.
