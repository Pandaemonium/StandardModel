...
/-!
# Aristotle target: representative-safe inverse-Fourier transport

This focused F1 target packages the landed componentwise changing-cell error
...
Proof handoff: every statement below has been selected for semantic shape.
Fill the proof holes without weakening hypotheses, replacing the actual
representative by an assumed `Lp` element, or changing the Fourier convention.
-/
...
namespace PhysicsSM.Draft.NullEdge.ContFourierF1Target
...
end PhysicsSM.Draft.NullEdge.ContFourierF1Target
