...
| 2 | Pluecker celestial bridge T1 | `ac0430a9-830b-4174-9151-672ab9faf98c` | `3e56f25d-7958-429c-9095-92af897a7aec` | integrated | Copied to `PhysicsSM/Draft/NullEdgePluckerCelestialBridge.lean`; imported by `PhysicsSMDraft`; targeted build and token scan passed |
| 3 | recoverability toy witness T3 | `95795ba9-6e20-4590-a6aa-6785a68607f7` | `ccbdba71-f00b-4f1d-8cd4-5d87e7375241` | integrated | Copied observer-channel scaffold and recoverability toy into `PhysicsSM/Draft`; imported by `PhysicsSMDraft`; targeted builds and token scan passed |
