...
namespace PhysicsSM.Draft.NullEdgeYukawaMassOperator
...
theorem physicalYukawaFlip_gaugeLegal (v : YukawaFlip) :
  ...
  cases v <;>
    exact ⟨⟨rfl, rfl⟩, ⟨rfl, rfl, rfl⟩, rfl, by
      norm_num [CandidateYukawaVertex.hyperchargeDefect,
        candidateOfYukawaFlip, multipletHypercharge, higgsHypercharge,
        YukawaFlip.leftMultiplet, YukawaFlip.rightMultiplet,
        YukawaFlip.higgsInsertion]⟩
...
theorem legalCandidate_has_yukawaMassOperator
  ...
  exact fun h =>
    ⟨h, scalarYukawaFlipOperator_sq_eq_massSq m,
      scalarYukawaFlipOperator_anticommutes_chirality m⟩

end PhysicsSM.Draft.NullEdgeYukawaMassOperator
