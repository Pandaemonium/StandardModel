...
/-!
# H3O Jordan identity: x component
...
-- Jordan identity for h₃(𝕆): off-diagonal x component (8 real polynomial identities)
theorem jordanIdentity_x (a b : H3O) :
    ((a ○ b) ○ (a ○ a)).x = (a ○ (b ○ (a ○ a))).x := by
