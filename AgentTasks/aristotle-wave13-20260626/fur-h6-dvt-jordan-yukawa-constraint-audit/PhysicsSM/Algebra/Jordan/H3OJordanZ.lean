...
/-!
# H3O Jordan identity: z component

Proves the z coordinate equality of the Jordan identity for `h₃(𝕆)`.
...
-- Jordan identity for h₃(𝕆): off-diagonal z component (8 real polynomial identities)
theorem jordanIdentity_z (a b : H3O) :
    ((a ○ b) ○ (a ○ a)).z = (a ○ (b ○ (a ○ a))).z := by
