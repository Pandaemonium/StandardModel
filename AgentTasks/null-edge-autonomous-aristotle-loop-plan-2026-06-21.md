...
| spinor-network-closure | `pluckerMass_eq_energy_sq_sub_closureDefect_sq`, `closed_spinorFan_is_restFrame` | `NullEdgeSpinorNetworkClosure/Finite.lean` | `f1be6e52-31cc-411b-86b7-a841b1cfd318` | INTEGRATED | celestial-moment | focused standalone `lake env lean` + integration review; not yet promoted to `PhysicsSM` |
...
| celestial-channel | `normSq_scalarBlochChannel`, `scalarChannel_massRatioSq_mono_of_contraction` | `NullEdgeCelestialScalarChannel/Finite.lean` | `d2ffbd94-bb7c-4582-94b5-1bafdc2ab481` | INTEGRATED | reduced-density | focused standalone `lake env lean` + integration review; not yet promoted to `PhysicsSM` |
...
| diamond-source | `DiamondSourceVisibility` defs | design only | `f01ec82f-ccac-44b6-b2c3-7b55433a2394` | STRATEGY-ONLY | - | API report copied; scaffold not imported; next proof jobs identified |
| diamond-source-core | `diamondSource_additive_iff_orthogonal`, `closed_visibleFan_mass_eq_restEnergy`, `visiblePluckerMass_sources_bulkTerm` | `Draft/NullEdgeDiamondSourceVisibilityRoadmap.lean` focused scaffold | `9b37228c-352d-4406-a29d-6946cb567b85` | INTEGRATED | diamond-source | standalone proof artifact copied and locally checked |
| qnec-audit | `relativeEntropyDataProcessing_for_diamondObserver`, `visiblePluckerFlux_satisfies_discreteANEC`, `diamondRelativeEntropy_secondDifference_nonnegative`, `sjDiamondReferenceState_def`, `petzRecoverabilityGap_controls_sourceVisibility` | design/proof split | `eb02f565-4285-416e-8eba-feddf43e6120` | INTEGRATED | diamond-source, relative-entropy observer channel | report copied; classical finite KL/DPI scaffold copied and locally checked |
