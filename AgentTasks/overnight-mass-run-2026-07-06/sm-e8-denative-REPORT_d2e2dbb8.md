...
For Furey complex-octonion particle-state work, avoid the unqualified phrase
"minimal left ideals of the complex octonions." The safe object is a module, or
minimal left ideal, for the associative left-action algebra generated by
complex-octonion left multiplication operators. Node/interactions should compose
linear maps and intertwiners; raw octonion products must be explicitly
parenthesized or lifted to left/right multiplication operators.
